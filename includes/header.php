...
<head>
    ...
    <link rel="icon" href="<?php echo get_url('images/twitter-logo.png'); ?>">
</head>
        ...
        <header class="header">
            ...
            <nav class="header__navigation">
                <ul>
                    ...
                    <li>
                        <?php if ($isAuth) { ?>
                            <!--Если пользователь находится в сессии, то отобржается кнопка выхода, и наоборот -->
            ...
            <section class="wrapper">
                <div class="main-header">
                    ...
                    <?php if ($isAuth) : ?>
                        ...
                        <a href="<?php echo get_url('includes/liked_posts.php') ?>" class="header__link header__link_likes" title="Понравившиеся твиты"></a>
                    <?php endif; ?>
